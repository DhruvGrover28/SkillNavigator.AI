...
const Register = ({ setIsAuthenticated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.terms) {
      console.log('Terms not accepted error')
      setError('Please accept the Terms of Service')
      setIsLoading(false)
      return
    }

    console.log('All validations passed, attempting real registration...')
    ...
    try {
      ...
      if (data.success) {
        ...
        console.log('Real user registered successfully, setting authenticated state...')
          ...
          <div className="max-w-md">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span>Smart resume parsing & optimization</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-white bg-opacity-20 rounded-full p-1">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>Application success analytics</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            <div className="flex items-center space-x-2 mb-8">
              ...
              <h1 className="text-2xl font-bold text-gray-900">SkillNavigator</h1>
            </div>
